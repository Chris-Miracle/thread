...
<template>
  <article class="grid grid-cols-[80px_1fr_auto] gap-3 border-b border-thread-line py-4">
    <img :src="item.product.image" :alt="item.product.name" width="160" height="200" loading="lazy" class="h-24 w-20 object-cover">
    <div class="min-w-0 py-0.5">
      ...
      <p class="mt-3 text-sm tabular-nums">{{ formatMoney(item.product.price, item.product.currency) }}</p>
